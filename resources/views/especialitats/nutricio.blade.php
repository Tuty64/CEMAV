  ...
  <section id="portada">
    <div class="container">
      <div class="content-center">
        <h1 style="position: absolute; top: 30%; left: 5%;">DIATISTA I NUTRICIÓ</h1>
       </div>
    </div>
  </section>
         ...
         <div class="col-12 col-md-12">
          <div class="row">
            <div  class="col-md-6">
              ...
              <p style="text-align: center; font-weight: 700">MARIA DORCA VILAMANYA</p>
              <p style="text-align: center;">N.Coleg 1436</p>
            </div>
         </div>
       </div>
    </div>
