  ...
  <section id="portada">
    <div class="container">
      <div class="content-center">
        <h1 style="position: absolute; top: 30%; left: 5%;">PODOLOGIA</h1>
       </div>
    </div>
  </section>
      ...
      <div class="content-center" style="margin-top: 50px">
       ...
       <div class="row">
         <div class="col-12 col-md-12">
          <div class="row">
            <div  class="col-md-6">
              <img src="img/Fotos Treballadors/marta.jpg" class="foto" alt="foto" style="width: 350px; height: 350px; margin: 0px 100px 50px 100px">
              <p style="text-align: center; font-weight: 700">MARTA SERRA RAURELL</p>
